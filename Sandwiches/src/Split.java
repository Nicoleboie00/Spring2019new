...
public static void middleofS() {
String food="applespineapplesbreadlettustomatobaconmayohambreadcheese";
...
*/
public static void middleofS2() {
String food="apples pineapples bread lettus tomato bacon mayo ham bread cheese";
	String[] middle =food.split("bread");
	System.out.println(middle [1]);
